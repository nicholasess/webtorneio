(function () {
    ...
    angular
        .module('app')
        .controller('AcademiaTorneioCtrl', AcademiaTorneioCtrl);

    AcademiaTorneioCtrl.$inject = ['$scope', '$location', 'AcademiaTorneioService', '$rootScope', 'filterFilter'];

    function AcademiaTorneioCtrl($scope, $location, AcademiaTorneioService, $rootScope, filterFilter) {
