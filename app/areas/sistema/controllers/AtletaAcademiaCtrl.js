...
(function () {
    ...
    angular
        .module('app')
        .controller('AtletaAcademiaCtrl', AtletaAcademiaCtrl);

    AtletaAcademiaCtrl.$inject = ['$scope', '$location', 'AtletaAcademiaService', '$rootScope', 'filterFilter'];

    function AtletaAcademiaCtrl($scope, $location, AtletaAcademiaService, $rootScope, filterFilter) {
